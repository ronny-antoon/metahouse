    ...
    namespace endpoint
    {
        namespace root_node
        {
            esp_matter::node_t *create(config_t *config)
            {
                ...
                ON_NULL_PRINT_RETURN(general_commissioning_cluster, nullptr, "Failed to create the general commissioning cluster");
                ...
                ON_NULL_PRINT_RETURN(network_commissioning_cluster, nullptr, "Failed to create the network commissioning cluster");
                ...
                ON_NULL_PRINT_RETURN(general_diagnostics_cluster, nullptr, "Failed to create the general diagnostics cluster");
                ...
                esp_matter::cluster_t *administrator_commissioning_cluster =
                    esp_matter::cluster::administrator_commissioning::create(endpoint, &(config->administrator_commissioning),
                                                                             esp_matter::cluster_flags::CLUSTER_FLAG_SERVER, ESP_MATTER_NONE_FEATURE_ID);
                ON_NULL_PRINT_RETURN(administrator_commissioning_cluster, nullptr, "Failed to create the administrator commissioning cluster");
                ...
                ON_NULL_PRINT_RETURN(operational_credentials_cluster, nullptr, "Failed to create the operational credentials cluster");
                ...
                ON_NULL_PRINT_RETURN(group_key_management_cluster, nullptr, "Failed to create the group key management cluster");
                ...
                ON_NULL_PRINT_RETURN(diagnostics_network_wifi_cluster, nullptr, "Failed to create the diagnostics network wifi cluster");
