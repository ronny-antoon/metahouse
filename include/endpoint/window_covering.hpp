...
constexpr static const uint32_t DEVICE_TYPE_ID =
    ESP_MATTER_WINDOW_COVERING_DEVICE_TYPE_ID;  // Window covering device type ID
...
constexpr static const uint32_t _CLUSTER_ID =
    chip::app::Clusters::WindowCovering::Id;  // Window covering cluster ID
 ...
 * @note If the aggregator is provided, the window covering will be created as bridged device on the
 * aggregator
 *
 */
