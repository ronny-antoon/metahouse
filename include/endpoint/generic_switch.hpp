...
constexpr static const uint32_t DEVICE_TYPE_ID =
    ESP_MATTER_GENERIC_SWITCH_DEVICE_TYPE_ID;  // Generic switch device type ID
constexpr static const uint8_t DEVICE_TYPE_VERSION =
    ESP_MATTER_GENERIC_SWITCH_DEVICE_TYPE_VERSION;  // Generic switch device type version
